        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                ...
                <div class="relative inline-flex">
                    ...
                    <select className='mt-5 bg-light-blue border border-gray-400 rounded-full text-gray-600 h-10 pl-5 pr-10 hover:border-gray-400 focus:outline-none appearance-none' onChange={(e) => { dispatch(setLangauge(e.target.value));}}>
