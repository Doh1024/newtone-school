      ...
      <div className='max-w-screen-lg mt-10 mx-auto flex flex-col items-center mb-16 justify-center'>
        <div className='flex w-2/3 md:w-full flex-col lg:flex-row md:items-center'>
          <div className='md:w-1/2 lg:-ml-20 lg:mr-24'>
            ...
            <h1 className="text-left font-semibold text-4xl pb-6 font-montserrat tracking-wide dark:text-dark-cyan">Our Winnipeg Campus</h1>
            <p className="mx-auto text-left font-montserrat dark:text-dark-cyan">Newtone programs are delivered in-person at our Downtown Winnipeg campus.</p>
            <p className="text-left w-9/10 lg:1/3 font-montserrat mx-auto pb-6 pt-6 dark:text-dark-cyan">We pride ourselves in providing a welcoming, inclusive and multi-cultural campus. Conveniently located near bus stops, cycling paths, public spaces and several local restaurants and cafés, our campus offers several amenities to compliment your studies. Learn alongside like-minded individuals and embark on your unique learning journey at Newtone.</p>
          </div>
          <div className='md:w-1/2 md:ml-20 md:-mr-20 flex items-center justify-center'>
            <div className="flex flex-col md:flex-row justify-center items-center mb-4">
              <blockquote className="bg-white rounded-lg shadow p-8 mb-5 sm:mr-4">
                ...
                <p className="text-black font-montserrat text-lg pt-10">Newtone's English language programs were engaging and the instructors truly cared about my success. With Newtone, I was able to attain the language skills needed to meet my PLAR requirements and excel in my learning and career journey.</p>
